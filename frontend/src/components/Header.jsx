...
function Header({ title, description }) {
    ...
    return (
        ...
        >
            ...
            <h3 className={`fs-2 ${styles.title}`}>Bem Vindo ao Portal Cósmico</h3>

            <p className={`text-center fs-6 ${styles.description}`}>"Explore os mistérios do universo, conecte-se com a energia dos
                astros e descubra a magia que habita dentro de você. Astrologia, espiritualidade
                e bruxaria para quem busca autoconhecimento e transformação."
            </p>
